...
import com.codeboy.qianghongbao.MainActivity;
 ...
 * @author LeonLee
 */
public class TaobaoAccessbilityJob extends BaseAccessbilityJob {

    private static final String TAG = "TaobaoAccessbilityJob";

    /** 微信的包名*/
    public static final String WECHAT_PACKAGENAME = "com.taobao.taobao";
    ...
    private void openTaoToken(){
        AccessibilityNodeInfo nodeInfo = getService().getRootInActiveWindow();

        if(nodeInfo!=null){
            MainActivity.nodeInfo=nodeInfo;
            AccessibilityNodeInfo node = AccessibilityHelper.findNodeInfosByText(nodeInfo, "立即查看");
